<script setup>
    ...
    const canSendMessage = computed(
        () => currentMessage.value.trim().length > 0 && !isLoading.value && props.isAvailable
    );
                ...
                <div ref="chatContainer" class="flex-1 overflow-y-auto p-4 space-y-4">
                    ...
                    <div v-if="!hasMessages" class="max-w-2xl mx-auto text-center py-8">
                        ...
                        <p class="text-gray-600 mb-6">
                            I'm here to help you with relationship advice, profile optimization, and navigating your
                            journey on ZawajAfrica.
                        </p>
                    ...
                    >
                        <div class="max-w-xs md:max-w-md lg:max-w-lg xl:max-w-xl">
                            ...
                            <div
                                ...
                                class="bg-red-50 border border-red-200 rounded-lg px-4 py-2"
                            >
                ...
                <div class="relative bg-white rounded-lg shadow-xl max-w-md w-full p-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <select
                                v-model="preferences.communication_style"
                        ...
                        <div>
                            ...
                            <select
                                v-model="preferences.advice_level"
                                class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                            >
