...
const nigerianCities = {
    ...
    'Lagos': ['Lagos Island', 'Ikeja', 'Lekki', 'Badagry', 'Epe', 'Ikorodu', 'Mushin', 'Surulere', 'Alimosho', 'Agege'],
                ...
                <div class="w-full max-w-[600px] px-8 md:px-[90px]">
                            ...
                            <div class="flex gap-4">
                                ...
                                >
                                    <div class="flex flex-col items-center py-6 px-4">
                                        ...
                                        <span class="text-lg font-medium" :class="form.gender === 'male' ? 'text-blue-600' : 'text-gray-700'">Male</span>
                                    </div>
                                </div>
                                ...
                                >
                                    <div class="flex flex-col items-center py-6 px-4">
                                        ...
                                        <span class="text-lg font-medium" :class="form.gender === 'female' ? 'text-pink-600' : 'text-gray-700'">Female</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="flex gap-4">
                                ...
                                >
                                    <div class="flex flex-col items-center py-6 px-4">
                                        ...
                                        <span class="text-lg font-medium" :class="form.interested_in === 'male' ? 'text-blue-600' : 'text-gray-700'">Male</span>
                                    </div>
                                </div>
                                ...
                                >
                                    <div class="flex flex-col items-center py-6 px-4">
                                        ...
                                        <span class="text-lg font-medium" :class="form.interested_in === 'female' ? 'text-pink-600' : 'text-gray-700'">Female</span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div v-if="currentStep === 3">
                        ...
                        <div class="mb-[30px]">
                            <div class="flex flex-col items-center">
                                <div class="w-full max-w-[280px] mb-8">
                                    ...
                                    <div class="flex justify-center gap-6 mb-6 relative">
                                        ...
                                        <div class="absolute left-0 right-0 top-[78px] h-[40px] bg-[#F5F5F5] rounded-md z-0"></div>
                                        ...
                                        <div class="relative w-[60px] h-[184px] z-10">
                                            ...
                                            >
                                                ...
                                                <div 
                                                    ...
                                                    :class="form.dob_day === day ? 'font-semibold text-[#654396]' : 'text-gray-400 hover:text-gray-600'"
                                                >
                                                    {{ day }}
                                                </div>
                                        ...
                                        <div class="relative w-[60px] h-[184px] z-10">
                                            ...
                                            >
                                                ...
                                                <div 
                                                    ...
                                                    :data-value="month"
                                                    class="h-[40px] flex items-center justify-center text-center text-xl transition-all duration-150 select-none" 
                                                    :class="form.dob_month === month ? 'font-semibold text-[#654396]' : 'text-gray-400 hover:text-gray-600'"
                                                >
                                                    {{ month }}
                                                </div>
                                        ...
                                        <div class="relative w-[60px] h-[184px] z-10">
                                            ...
                                            >
                                                ...
                                                <div 
                                                    ...
                                                    :data-value="year"
                                                    class="h-[40px] flex items-center justify-center text-center text-xl transition-all duration-150 select-none" 
                                                    :class="form.dob_year === year ? 'font-semibold text-[#654396]' : 'text-gray-400 hover:text-gray-600'"
                                                >
                                                    {{ year }}
                                                </div>
                                    ...
                                    <div class="relative w-full h-0">
                                        ...
                                        <div class="absolute left-0 right-0 top-[-130px] border-b border-[#654396] w-full"></div>
                                        <div class="absolute left-0 right-0 top-[-90px] border-b border-[#654396] w-full"></div>
                                    </div>
                                    
                                    <!-- Age display - ensure visibility -->
                                    <div v-if="calculateAge !== null" class="text-center text-lg font-medium text-[#654396] mt-6 p-3 bg-[#F5F5F5] rounded-lg">
                            ...
                            <InputError class="mt-2" :message="form.errors.dob_day || form.errors.dob_month || form.errors.dob_year" />
                        </div>
                    </div>
                                    ...
                                    <div class="flex items-center rounded-lg bg-[#F5F5F5] px-5 py-5">
                                        <div class="mr-3 h-5 w-5 flex-shrink-0">
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 36 36">
                                                <path fill="#186648" d="M36 27c0 2.209-1.791 4-4 4H4c-2.209 0-4-1.791-4-4V9c0-2.209 1.791-4 4-4h28c2.209 0 4 1.791 4 4v18z"></path>
                                                <path fill="#FFFFFF" d="M4 5h8v26H4c-2.209 0-4-1.791-4-4V9c0-2.209 1.791-4 4-4zm20 0h8c2.209 0 4 1.791 4 4v18c0 2.209-1.791 4-4 4h-8V5z"></path>
                                            </svg>
                                        </div>
                                        <input
                                            id="country"
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <select
                                            ...
                                            :disabled="!form.state"
                                        >
                                            <option value="" disabled selected>{{ form.state ? 'Select your city' : 'Please select a state first' }}</option>
                    ...
                    <div class="mt-[40px] space-y-5">
                        <button
                            ...
                            type="button"
                            :disabled="(currentStep === 2 && (!form.gender || !form.interested_in)) || 
