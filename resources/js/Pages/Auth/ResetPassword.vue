                    ...
                    <div v-else class="text-center">
                        ...
                        <div class="flex justify-center mb-8">
                            <div class="relative w-[85px] h-[85px]">
                                ...
                                <div class="absolute inset-[10px] bg-[#654396] rounded-full flex items-center justify-center">
                        ...
                        <p class="text-lg text-gray-600 mb-10">
                            A password reset email has been sent your email. You can now reset the password to the email.
                        </p>
