<template>
    ...
    <div class="flex flex-col md:flex-row min-h-screen bg-gray-50 relative">
        ...
        <div class="fixed top-0 left-0 right-0 z-50 bg-white shadow-md p-4 flex items-center md:hidden">
            ...
            <!-- Back Button -->
            <button @click="goBack" class="p-1 mr-3 hover:bg-gray-100 rounded-full">
                <svg class="w-5 h-5 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7" />
                </svg>
            </button>

            <h1 class="text-lg font-bold">Therapist Profile</h1>
        </div>
        ...
        <div class="flex-1 flex flex-col overflow-hidden mt-16 md:mt-0 md:ml-64">
            ...
            <div class="flex-1 overflow-y-auto p-4 lg:p-10">
                <div class="max-w-4xl mx-auto">
                        ...
                        <div class="flex flex-col md:flex-row">
                            ...
                            <div class="md:w-1/3 bg-white p-4 lg:p-6 flex items-center justify-center">
                                <div class="w-full max-w-xs">
                                    <div
                                        class="w-full h-40 md:h-48 lg:h-56 rounded-lg overflow-hidden bg-gray-200 shadow-lg"
                                    >
                                        <img
                                ...
                                <div class="mb-4 lg:mb-6">
                                    ...
                                    <div class="grid grid-cols-3 gap-2 lg:gap-4 mb-4 lg:mb-6">
                                        <div class="text-center bg-gray-100 rounded-lg p-2 lg:p-3">
                                            <span class="block text-sm lg:text-lg font-semibold text-purple-600">
                                        ...
                                        <div class="text-center bg-gray-100 rounded-lg p-2 lg:p-3">
                                            <span class="block text-sm lg:text-lg font-semibold text-purple-600">
                                                {{ therapist.session_duration || '90 min' }}
                                            </span>
                                            <span class="text-xs lg:text-sm text-grey-500">Session</span>
                                        </div>
                                        <div class="text-center bg-gray-100 rounded-lg p-2 lg:p-3">
                                            <div class="flex items-center justify-center mb-1">
                                                <span class="text-sm lg:text-lg font-semibold text-gray-900 mr-1">
                                                    {{ therapist.avg_rating?.toFixed(1) || '4.5' }}
                                                </span>
                                                <div class="flex">
                                                    <svg
                                                        v-for="star in 5"
                                                        ...
                                                        :class="
                                                            star <= Math.floor(therapist.avg_rating || 4.5)
                                                                ? 'text-yellow-400'
                                                                : 'text-gray-300'
                                                        "
                                                        fill="currentColor"
                    ...
                    <div class="mt-4 lg:mt-6 bg-white rounded-lg shadow-sm border border-gray-200">
                        <div class="p-4 lg:p-6">
                            ...
                            <div v-if="showAvailableHours" class="mt-4 border-t pt-4">
                                <div
                                    v-if="
                                        therapist.schedule_by_day && Object.keys(therapist.schedule_by_day).length > 0
                                    "
                                    class="space-y-3"
                                >
                                    <div
                                        v-for="(slots, day) in therapist.schedule_by_day"
                                        :key="day"
                                        class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2"
                                    >
                                        <span class="font-medium text-gray-900 capitalize text-sm lg:text-base">
                                            {{ day }}
                                        </span>
                                ...
                                <div v-else class="text-gray-500 text-center py-4">
                                    <p class="text-sm lg:text-base">
                                        {{ therapist.working_hours || 'Schedule information not available' }}
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div
                        v-if="therapist.bio"
                        class="mt-4 lg:mt-6 bg-white rounded-lg shadow-sm border border-gray-200 p-4 lg:p-6"
                    >
                    ...
                    <div
                        v-if="therapist.additional_info"
                        class="mt-4 lg:mt-6 bg-white rounded-lg shadow-sm border border-gray-200 p-4 lg:p-6"
                    >
        ...
        <div v-if="showBookingSlider" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-end z-50">
            <div
                class="bg-white w-full max-w-md h-full overflow-y-auto shadow-xl transform transition-transform duration-300 ease-in-out"
            ...
            >
                ...
                <div class="p-4">
                    ...
                    <div class="flex items-center space-x-3 mb-6">
                        <img
                            :src="therapist.photo_url || '/images/male.png'"
                            :alt="therapist.name"
                        ...
                        <div>
                            ...
                            <p class="text-sm text-green-600 font-medium">
                                Online Consultation Fee: ₦{{ therapist.hourly_rate?.toLocaleString() }}
                            </p>
                    ...
                    <div class="mb-6">
                        ...
                        <div class="space-y-3">
                            <!-- Google Meet -->
                            <div
                                @click="selectedPlatform = 'google_meet'"
                                :class="[
                            ...
                            >
                                ...
                                >
                                    <div
                                        v-if="selectedPlatform === 'google_meet'"
                    ...
                    <div class="mb-6">
                        ...
                        <div class="grid grid-cols-7 gap-2 mb-4">
                            <div
                                ...
                                :class="[
                                    'text-center p-3 rounded-lg cursor-pointer transition-all border',
                    ...
                    <button
                        ...
                        :class="[
                            'w-full py-4 rounded-lg font-medium text-white transition-all mt-6',
                ...
                <div class="p-4">
                    ...
                    <div class="space-y-4 mb-8">
                        ...
                        <div
                            ...
                            :class="[
                                'flex items-center justify-between p-4 border-2 rounded-lg cursor-pointer transition-all',
                                selectedPaymentGateway === 'monnify'
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <div class="text-right">
                                ...
                                <p class="text-lg font-bold text-purple-600">
                                    ₦{{ therapist.hourly_rate?.toLocaleString() }}
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex space-x-3">
                        ...
                        <!-- Continue Button -->
                        <button
                            @click="proceedWithSelectedGateway"
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-3 mb-6">
                        ...
                        >
                            <div class="text-center">
                                ...
                                <div
                                    v-if="selectedCardType === cardType.id"
                                    class="w-3 h-3 bg-purple-500 rounded-full mx-auto mt-1"
                                ></div>
                            </div>
                        </div>
                    </div>
...
<script setup>
    ...
    const isCardDetailsValid = computed(() => {
        return (
            cardDetails.value.holderName.trim() !== '' &&
