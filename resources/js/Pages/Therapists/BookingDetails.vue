...
<template>
    ...
    <div class="flex flex-col md:flex-row min-h-screen bg-gray-50 relative">
        ...
        <div class="fixed top-0 left-0 right-0 z-50 bg-purple-600 shadow-md p-4 flex items-center md:hidden">
            ...
            <h1 class="text-lg text-white font-bold">My Bookings</h1>
        </div>
                ...
                <div class="mx-auto max-w-7xl">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-8">
                        <div
                            ...
                            :class="!filters.status ? 'ring-2 ring-purple-500' : ''"
                        ...
                        <div
                            class="bg-white overflow-hidden shadow rounded-lg cursor-pointer"
                            :class="filters.status === 'pending' ? 'ring-2 ring-purple-500' : ''"
                            @click="filterForm.status = 'pending'"
                        >
                            <div class="p-5">
                                <div class="flex items-center">
                                    <div class="flex-shrink-0">
                        ...
                        <div
                            class="bg-white overflow-hidden shadow rounded-lg cursor-pointer"
                            :class="filters.status === 'upcoming' ? 'ring-2 ring-purple-500' : ''"
                            @click="filterForm.status = 'upcoming'"
                        >
                            <div class="p-5">
                                <div class="flex items-center">
                                    <div class="flex-shrink-0">
                        ...
                        <div
                            class="bg-white overflow-hidden shadow rounded-lg cursor-pointer"
                            :class="filters.status === 'paid' ? 'ring-2 ring-purple-500' : ''"
                            @click="filterForm.status = 'paid'"
                        >
                            <div class="p-5">
                                <div class="flex items-center">
                                    <div class="flex-shrink-0">
                        ...
                        <div
                            class="bg-white overflow-hidden shadow rounded-lg cursor-pointer"
                            :class="filters.status === 'completed' ? 'ring-2 ring-purple-500' : ''"
                            @click="filterForm.status = 'completed'"
                        >
                            <div class="p-5">
                                <div class="flex items-center">
                                    <div class="flex-shrink-0">
                        ...
                        <div
                            class="bg-white overflow-hidden shadow rounded-lg cursor-pointer"
                            :class="filters.status === 'past' ? 'ring-2 ring-purple-500' : ''"
                            @click="filterForm.status = 'past'"
                        >
                            <div class="p-5">
                                <div class="flex items-center">
                                    <div class="flex-shrink-0">
                            ...
                            <li v-for="booking in bookings.data" :key="booking.id" class="px-6 py-6">
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center space-x-4">
                                        <div class="flex-shrink-0">
                                            <img
                                                v-if="booking.therapist?.photo_url"
                                        ...
                                        <div class="min-w-0 flex-1">
                                            <div class="flex items-center space-x-3">
                                                <p class="text-lg font-medium text-gray-900 truncate">
                                                    {{ booking.therapist?.name || 'Unknown Therapist' }}
                                                </p>
                                                <span
                                            ...
                                            <div v-if="booking.admin_notes" class="mt-2">
                                                <p class="text-sm text-blue-600">
                                                    <span class="font-medium">Therapist notes:</span>
                                                    {{ booking.admin_notes }}
                                                </p>
                                            </div>
                                            <div
                                            ...
                                            >
                                                <a
                                                    ...
                                                    target="_blank"
                                                    class="inline-flex items-center text-sm text-purple-600 hover:text-purple-500"
                                                >
                                                    <svg
                                                        class="mr-2 h-4 w-4"
                                                        fill="none"
                                    ...
                                    <div class="flex items-center space-x-2">
                                        <Link
                                            v-if="booking.therapist"
                                            :href="route('therapists.show', booking.therapist.id)"
                        ...
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                            ...
                            <div class="mt-2">
                                <p class="text-sm text-gray-500">
                                    ...
                                    {{ selectedBooking?.therapist?.name }}? This action cannot be undone.
                                </p>
                            </div>
                            <div class="mt-4">
