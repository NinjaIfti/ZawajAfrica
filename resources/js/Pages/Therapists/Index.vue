        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <div class="flex-1 overflow-y-auto p-4 lg:p-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 lg:gap-6">
                    <div v-for="therapist in filteredTherapists" :key="therapist.id" class="bg-white rounded-2xl shadow-sm border border-gray-200 p-4 lg:p-5 hover:shadow-md transition-shadow duration-200">
                        <!-- Profile Picture -->
                        <div class="flex justify-center mb-3 lg:mb-4">
                            <div class="relative">
                                <div class="w-14 h-14 lg:w-16 lg:h-16 rounded-full overflow-hidden bg-gray-200 border-2 border-orange-300">
                                    <img 
                                    ...
                                    <div v-else class="w-full h-full bg-gray-300 flex items-center justify-center">
                                        <svg class="w-6 h-6 lg:w-8 lg:h-8 text-gray-400" fill="currentColor" viewBox="0 0 20 20">
                                            <path fill-rule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clip-rule="evenodd" />
                                        </svg>
                                    </div>
                                </div>
                                <!-- Online status indicator -->
                                <div class="absolute -bottom-1 -right-1 w-4 h-4 lg:w-5 lg:h-5 bg-green-500 rounded-full border-2 border-white"></div>
                            </div>
                        </div>
                        ...
                        <div class="flex justify-between items-center mb-3 lg:mb-4 text-xs lg:text-sm">
                            ...
                            <div class="text-center">
                                <div class="flex items-center justify-center mb-1">
                                    ...
                                    <svg class="w-3 h-3 lg:w-4 lg:h-4 text-yellow-400" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div v-if="filteredTherapists.length === 0" class="text-center py-8 lg:py-12">
                    <div class="w-16 h-16 lg:w-24 lg:h-24 mx-auto mb-4 bg-gray-200 rounded-full flex items-center justify-center">
