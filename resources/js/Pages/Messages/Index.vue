            ...
            <div class="flex flex-col md:flex-row h-full">
                        ...
                        <div class="space-y-2">
                            ...
                            >
                                ...
                                <div class="relative h-12 w-12 flex-shrink-0 overflow-hidden rounded-full">
                                    <img :src="conversation.profile_photo" :alt="conversation.name" class="h-full w-full object-cover" />
                                    <div v-if="conversation.is_online" class="absolute bottom-0 right-0 h-3 w-3 rounded-full bg-green-500 ring-1 ring-white"></div>
                                </div>
                                ...
                                <!-- Unread Count Badge -->
                                <div v-if="conversation.unread_count > 0" class="ml-2 flex h-5 w-5 items-center justify-center rounded-full bg-purple-600 text-xs font-medium text-white">
                ...
                <div class="hidden md:flex md:w-2/3 md:flex-col md:items-center md:justify-center md:p-8">
                    <div class="text-center">
                        <img src="/images/message-empty.svg" alt="No message selected" class="mx-auto h-32 w-32 opacity-50" />
