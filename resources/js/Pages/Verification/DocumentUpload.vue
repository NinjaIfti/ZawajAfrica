...
<template>
    ...
    <div class="flex min-h-screen items-center justify-center bg-gray-100">
        <div class="w-full max-w-[600px] rounded-xl bg-white p-8 shadow-md">
            <div class="mb-12 flex items-center justify-between">
                <div class="flex flex-col">
                    <h1 class="text-xl font-bold text-black">Upload {{ documentTitle }}</h1>
                    <p class="text-sm text-gray-600">Upload both sides of your {{ documentTitle.toLowerCase() }}</p>
                </div>
            ...
            <form @submit.prevent="submitForm">
                <div class="space-y-4">
                    <!-- Front Image -->
                    <div class="mb-8">
                        <label class="mb-2 block text-base font-medium text-gray-900">Upload Front Picture <span class="text-red-600">*</span></label>
                        <div 
                            class="flex items-center justify-center w-full h-[280px] border border-purple-600 rounded-xl overflow-hidden"
                        ...
                        >
                            <div v-if="!showFrontPreview" class="text-center">
                                ...
                                <label 
                                    for="front-image" 
                                    class="flex flex-col items-center justify-center cursor-pointer p-6"
                                >
                                    ...
                                    <p class="mt-2 text-sm text-gray-600">Click to upload the front of your {{ documentTitle.toLowerCase() }}</p>
                                </label>
                            </div>
                        ...
                        <div v-if="form.errors.front_image" class="mt-1 text-sm text-red-600">
                            {{ form.errors.front_image }}
                        </div>
                    </div>

                    <!-- Back Image -->
                    <div class="mb-8" v-if="props.documentType !== 'voters_register'">
                        <label class="mb-2 block text-base font-medium text-gray-900">Upload Back Picture <span class="text-red-600">*</span></label>
                        <div 
                            class="flex items-center justify-center w-full h-[280px] border border-purple-600 rounded-xl overflow-hidden"
                        ...
                        >
                            <div v-if="!showBackPreview" class="text-center">
                                ...
                                >
                                    ...
                                    <p class="mt-2 text-sm text-gray-600">Click to upload the back of your {{ documentTitle.toLowerCase() }}</p>
                                </label>
                            </div>
                            <div v-else class="relative w-full h-full">
                        ...
                        <div v-if="form.errors.back_image" class="mt-1 text-sm text-red-600">
