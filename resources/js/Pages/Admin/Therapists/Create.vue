                    ...
                    <div class="p-6 bg-white border-b border-gray-200">
                        ...
                        <form @submit.prevent="submit" class="space-y-6">
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <div v-if="photoPreview" class="mt-2">
                                        <img :src="photoPreview" alt="Preview" class="h-24 w-24 rounded-full object-cover">
                                    </div>
                            ...
                            <div class="space-y-4 border-t pt-6">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input v-model="form.degree" type="text" id="degree" required
                                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                        <div v-if="form.errors.degree" class="mt-1 text-sm text-red-600">{{ form.errors.degree }}</div>
                                    </div>

                                    <div>
                                        <label for="years_of_experience" class="block text-sm font-medium text-gray-700">Years of Experience *</label>
                                        <input v-model="form.years_of_experience" type="number" id="years_of_experience" min="0" required
                                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                        <div v-if="form.errors.years_of_experience" class="mt-1 text-sm text-red-600">{{ form.errors.years_of_experience }}</div>
                                    </div>

                                    <div>
                                        <label for="hourly_rate" class="block text-sm font-medium text-gray-700">Hourly Rate ($)</label>
                                        <input v-model="form.hourly_rate" type="number" id="hourly_rate" step="0.01" min="0"
                                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                        <div v-if="form.errors.hourly_rate" class="mt-1 text-sm text-red-600">{{ form.errors.hourly_rate }}</div>
                                    </div>

                                    <div>
                                        <label for="languages" class="block text-sm font-medium text-gray-700">Languages</label>
                                        <input v-model="form.languages" type="text" id="languages" placeholder="e.g., English, Arabic, French"
                                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                        <div v-if="form.errors.languages" class="mt-1 text-sm text-red-600">{{ form.errors.languages }}</div>
                                    </div>
                                </div>
                                ...
                                <div v-if="specializations">
                                    ...
                                    <div v-if="form.errors.specializations" class="mt-1 text-sm text-red-600">{{ form.errors.specializations }}</div>
                                </div>
                            </div>
                            ...
                            <div class="space-y-4 border-t pt-6">
                                ...
                                <p class="text-sm text-gray-600">Select available time slots for each day of the week.</p>
                                
                                <div class="space-y-3">
                                    <div v-for="day in days" :key="day" class="border rounded-lg p-4">
                                        <h4 class="font-medium text-gray-900 mb-2">{{ day }}</h4>
                                        <div class="grid grid-cols-3 md:grid-cols-4 gap-2">
                                            <label v-for="time in timeSlots" :key="`${day}-${time}`" class="flex items-center text-sm">
                                                <input type="checkbox" :checked="isAvailable(day, time)" 
                                ...
                                <div v-if="form.errors.availability" class="mt-1 text-sm text-red-600">{{ form.errors.availability }}</div>
                            </div>
                            ...
                            <div class="space-y-4 border-t pt-6">
                                ...
                                <div>
                                    ...
                                    <textarea v-model="form.additional_info" id="additional_info" rows="3"
                                              class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"></textarea>
                            ...
                            <div class="flex items-center justify-end space-x-3 pt-6 border-t">
                                <Link :href="route('admin.therapists.index')" 
