...
const approveVerification = () => {
    router.post(route('admin.verifications.approve', { userId: props.user.id }), {}, {
        onSuccess: () => {
...
const rejectVerification = () => {
    ...
    router.post(route('admin.verifications.reject', { userId: props.user.id }), {
                        ...
                        <div class="mb-8">
                            ...
                            <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                                <div>
                                    ...
                                    <p class="font-medium">{{ documentTypes[props.verification.document_type] || props.verification.document_type }}</p>
                                </div>
                                <div>
