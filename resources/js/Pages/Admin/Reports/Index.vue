...
<template>
    ...
    <AdminLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">User Reports</h2>
        </template>
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    <tr v-for="report in reports?.data || []" :key="report.id">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            ...
                                            <div class="text-sm text-gray-900" v-else>[Deleted User]</div>
                                            ...
                                            <template v-if="reports.links && reports.links.length > 0">
                                                <template v-for="(link, i) in reports.links" :key="i">
                                                    <Link
                                                        ...
                                                        :class="{
                                                            'text-indigo-600 z-10': link.active,
