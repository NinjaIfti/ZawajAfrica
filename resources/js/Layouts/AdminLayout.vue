...
<template>
    <div class="min-h-screen bg-gray-100">
        ...
        <div
            class="fixed inset-y-0 left-0 z-40 w-64 transform transition duration-300 lg:translate-x-0 bg-gray-900 text-white"
        >
            <!-- Logo -->
        ...
        <div
            ...
            :class="{ 'translate-x-0': showingMobileMenu, '-translate-x-full': !showingMobileMenu }"
        >
