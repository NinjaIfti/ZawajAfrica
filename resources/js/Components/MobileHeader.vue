...
<template>
    ...
    <div class="md:hidden fixed top-0 left-0 right-0 z-50 bg-purple-600 shadow-md p-4 flex items-center">
        ...
        <div class="flex items-center gap-2">
            <h1 class="text-lg font-bold text-white">Welcome {{ user.name }}!</h1>
        ...
        <div class="profile-dropdown relative ml-auto">
            <div
                ...
                class="h-8 w-8 overflow-hidden rounded-full bg-gray-300 cursor-pointer"
            >
                <img
    ...
    <div v-if="showPasswordModal && deletePassword === undefined" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
    ...
    <div v-if="showPasswordModal && deletePassword !== undefined" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
        <div class="bg-white rounded-lg p-6 max-w-md w-full mx-4">
            ...
            <form @submit.prevent="confirmPasswordAndDelete" class="space-y-4">
                <!-- Password -->
                <div>
                    <label for="delete_password_mobile" class="block text-sm font-medium text-gray-700 mb-1">
                        Password
                    </label>
                    <input
                        id="delete_password_mobile"
