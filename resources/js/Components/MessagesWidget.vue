        ...
        <div class="p-4">
            ...
            <div class="space-y-4">
                ...
                <div v-if="messages && messages.length > 0">
                    <div v-for="message in messages" :key="message.id" class="flex items-center justify-between">
                        ...
                        <div class="flex flex-col items-end">
                            ...
                            <div
                                v-if="message.unread"
                                class="mt-1 h-6 w-6 rounded-full bg-purple-600 text-center text-sm text-white flex items-center justify-center"
                            >
                                3
                            </div>
                        </div>
