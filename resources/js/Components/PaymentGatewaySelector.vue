            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                >
                    <div class="flex items-center justify-between">
                        ...
                        <div class="w-5 h-5 rounded-full border-2 border-gray-300 flex items-center justify-center">
                            <div v-if="selectedGateway === 'paystack'" class="w-3 h-3 bg-green-500 rounded-full"></div>
                        </div>
                    </div>
                </div>
                ...
                >
                    <div class="flex items-center justify-between">
                        ...
                        <div class="w-5 h-5 rounded-full border-2 border-gray-300 flex items-center justify-center">
                            <div v-if="selectedGateway === 'monnify'" class="w-3 h-3 bg-purple-500 rounded-full"></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="flex items-start space-x-3">
                ...
                <div>
                    ...
                    <p class="text-sm text-orange-700 mt-1">
                        You'll be redirected to Monnify's secure payment page where you can pay with cards, bank
                        transfer, or USSD.
                    </p>
                    <div class="mt-3 text-lg font-semibold text-orange-900">Amount: {{ formatAmount(amount) }}</div>
                </div>
            </div>
        </div>
            ...
            <div class="flex items-start space-x-3">
                ...
                <div>
                    ...
                    <p class="text-sm text-green-700 mt-1">
                        You'll be redirected to Paystack's secure payment page where you can pay with cards, bank
                        transfer, or USSD.
                    </p>
                    <div class="mt-3 text-lg font-semibold text-green-900">Amount: {{ formatAmount(amount) }}</div>
                </div>
            </div>
        </div>
