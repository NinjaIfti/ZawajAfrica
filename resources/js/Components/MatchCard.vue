...
<template>
    <div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:block space-y-0 lg:space-y-6 gap-5 md:gap-6">
            <div v-for="match in matches" :key="match.id" class="relative overflow-hidden rounded-lg bg-gray-800 shadow-lg lg:mb-6">
                    ...
                    <div class="h-48 sm:h-56 md:h-64 w-full bg-gray-700 relative">
                        ...
                        <div class="absolute bottom-3 left-3 right-3">
                            <div class="flex items-center justify-between mb-1 text-white">
                                <span class="text-sm font-medium">{{ match.compatibility }}%</span>
                ...
                <div class="bg-white px-4 py-3 relative overflow-hidden">
                    <div class="flex items-center justify-between">
                        <Link :href="route('profile.view', { id: match.id })" class="block flex-1 min-w-0">
                            <div class="flex items-center">
                                ...
                                <span class="ml-1 text-gray-500 text-sm flex-shrink-0">, {{ match.age }}</span>
                            </div>
                            <p class="text-gray-600 text-sm truncate">{{ match.location }}</p>
                    ...
                    <div class="absolute bottom-0 right-8 h-16 md:h-20 w-20 md:w-24 translate-x-1/3 translate-y-1/4 hidden sm:block">
